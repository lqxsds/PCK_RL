...
###############################################################################################
            ...
            builder = self.scene.create_actor_builder()
            builder.add_nonconvex_collision_from_file(filename='/home/lqx/ManiSkill-3.0.0b15/mani_skill/envs/tasks/tabletop/xiao.obj')
            builder.add_visual_from_file(filename='/home/lqx/ManiSkill-3.0.0b15/mani_skill/envs/tasks/tabletop/xiao.obj')
    ...
    def has_peg_inserted(self):
        ...
        x_flag = -0.12 <= peg_head_pos_at_hole[:, 0]
